...
@property (nonatomic, copy) UIImage *originalContentImage;
@property (nonatomic) UIColor *originalContentTintColor;
...
- (id)initWithFrame:(CGRect)frame startItem:(AwesomeMenuItem*)startItem optionMenus:(NSArray *)aMenusArray
{
    ...
    if (self) {
        ...
        self.originalContentImage = startItem.contentImageView.image;
        _startButton.contentImageView.tintColor = [UIColor whiteColor];
...
- (void)setTintColor:(UIColor *)tintColor{
    self.originalContentTintColor = tintColor;
